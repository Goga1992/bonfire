...
void audiomixer_orc_sub_s16 (gint16 * ORC_RESTRICT d1, const gint16 * ORC_RESTRICT s1, int n);
...
/* audiomixer_orc_sub_s16 */
#ifdef DISABLE_ORC
void
audiomixer_orc_sub_s16 (gint16 * ORC_RESTRICT d1, const gint16 * ORC_RESTRICT s1, int n){
  int i;
  orc_union16 * ORC_RESTRICT ptr0;
  const orc_union16 * ORC_RESTRICT ptr4;
  orc_union16 var32;
...
#else
static void
_backup_audiomixer_orc_sub_s16 (OrcExecutor * ORC_RESTRICT ex)
{
  int i;
  int n = ex->n;
  orc_union16 * ORC_RESTRICT ptr0;
...
audiomixer_orc_sub_s16 (gint16 * ORC_RESTRICT d1, const gint16 * ORC_RESTRICT s1, int n)
{
  ...
  if (!p_inited) {
    ...
    if (!p_inited) {
      ...
      static const orc_uint8 bc[] = {
        1, 9, 22, 97, 117, 100, 105, 111, 109, 105, 120, 101, 114, 95, 111, 114, 
        99, 95, 115, 117, 98, 95, 115, 49, 54, 11, 2, 2, 12, 2, 2, 99, 
        0, 0, 4, 2, 0, 
      };
      p = orc_program_new_from_static_bytecode (bc);
      orc_program_set_backup_function (p, _backup_audiomixer_orc_sub_s16);
#else
      p = orc_program_new ();
      orc_program_set_name (p, "audiomixer_orc_sub_s16");
      orc_program_set_backup_function (p, _backup_audiomixer_orc_sub_s16);
      orc_program_add_destination (p, 2, "d1");
      orc_program_add_source (p, 2, "s1");

      orc_program_append_2 (p, "subssw", 0, ORC_VAR_D1, ORC_VAR_D1, ORC_VAR_S1, ORC_VAR_D1);
#endif
